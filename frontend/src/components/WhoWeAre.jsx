              ...
              <div className="flex items-center -mx-3 sm:-mx-4">
                <div className="w-full px-3 sm:px-4 xl:w-1/2">
                  <div className="py-3 sm:py-4">
                    <img
                      src="https://cdn.pixabay.com/photo/2017/02/02/05/49/earth-2032075_640.jpg"
                      alt=""
                  ...
                  <div className="py-3 sm:py-4">
                    <img
                      src="https://images.unsplash.com/photo-1628632577468-645afac21c82?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                      alt=""
                      className="w-full rounded-2xl"
                    />
                  </div>
                ...
                <div className="w-full px-3 sm:px-4 xl:w-1/2">
                  <div className="relative z-10 my-4">
                    <img
                      src="https://images.unsplash.com/photo-1454789476662-53eb23ba5907?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8dG9ybmFkb3xlbnwwfDF8MHx8fDA%3D"
                      alt=""
                      className="w-full rounded-2xl"
                    />
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="mt-10 lg:mt-0">
                ...
                <p className="mb-8 text-base text-body-color dark:text-dark-6">
                  ...
                  improves emergency preparedness and response but also enriches
                  development aid activities across a multitude of sectors. Our
                  operations underpin the essential decision-making processes
                  for UN agencies, humanitarian clusters, non-governmental
